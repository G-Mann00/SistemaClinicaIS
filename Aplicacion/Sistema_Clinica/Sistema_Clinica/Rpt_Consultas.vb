...
Public Class Rpt_Consultas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Clinica.Rpt_Consultas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Consultas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Consultas = New Rpt_Consultas()
        rpt.Site = Me.Site
        Return rpt
    End Function
