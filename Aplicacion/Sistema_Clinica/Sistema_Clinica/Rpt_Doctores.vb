...
Public Class Rpt_Doctores
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Clinica.Rpt_Doctores.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Doctores
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Doctores = New Rpt_Doctores()
        rpt.Site = Me.Site
        Return rpt
    End Function
