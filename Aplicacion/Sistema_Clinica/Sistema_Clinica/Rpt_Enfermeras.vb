...
Public Class Rpt_Enfermeras
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Clinica.Rpt_Enfermeras.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Enfermeras
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Enfermeras = New Rpt_Enfermeras()
        rpt.Site = Me.Site
        Return rpt
    End Function
