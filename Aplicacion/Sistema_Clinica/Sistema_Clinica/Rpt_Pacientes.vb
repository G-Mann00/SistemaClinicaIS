...
Public Class Rpt_Pacientes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Clinica.Rpt_Pacientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Pacientes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Pacientes = New Rpt_Pacientes()
        rpt.Site = Me.Site
        Return rpt
    End Function
